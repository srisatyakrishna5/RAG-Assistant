...
def generate_document_summary(
    ...
    * Response directly in the target language (no post-hoc translation for
      the summary, though :func:`~services.translation.translate_text` is
      still called as a safety net for the English fall-through path).
